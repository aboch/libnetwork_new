...
type Driver interface {
	...
	CreateNetwork(nid string, options map[string]interface{}, data []ipamapi.IPData) error
...
type InterfaceInfo interface {
	...
	// during the call to CreateEndpoint, if the address is not already set. If the
	// endpoint interface already has an ip address assigned and driver replaces it with
	// a different IP, libnetwork will fail the endpoint creation.
