...
func TestCreateFullOptions(t *testing.T) {
	...
	err := d.CreateNetwork("dummy", netOption, nil)
	if err != nil {
...
func TestCreateNoConfig(t *testing.T) {
	...
	if err := d.CreateNetwork("dummy", genericOption, nil); err != nil {
		t.Fatalf("Failed to create bridge: %v", err)
	}
}
...
func TestCreate(t *testing.T) {
	...
	err := d.CreateNetwork("dummy", genericOption, nil)
	if err == nil {
...
func TestCreateMultipleNetworks(t *testing.T) {
	...
	if err := d.CreateNetwork("4", genericOption, nil); err != nil {
		t.Fatalf("Failed to create bridge: %v", err)
	}
...
func (i *testInterface) SetMacAddress(mac net.HardwareAddr) error {
	if i.mac != nil && !bytes.Equal(i.mac, mac) {
...
func testQueryEndpointInfo(t *testing.T, ulPxyEnabled bool) {
	...
	err := d.CreateNetwork("net1", genericOption, nil)
	if err != nil {
		t.Fatalf("Failed to create bridge: %v", err)
	}
...
func TestCreateLinkWithOptions(t *testing.T) {
	...
	err := d.CreateNetwork("net1", netOptions, nil)
	if err != nil {
		t.Fatalf("Failed to create bridge: %v", err)
	}
